...
本次发布保留 **2026-09-07 的 HiSparse 参考参数完整 A1/B1/B2/A2 实验**，以及
**2026-09-26 历史 GDS 与公开 Tutti v0.1.1 的同盘关键对照**：
[关键对照](public-v011-cb-20260926/README.md)。测量日期与仓库整理日期不同；这些记录不表示服务器当前状态。
